/* lib_lst.c - doubly linked list subroutine library */
...
void lstInit
    (
    register LIST *pList     /* ptr to list descriptor to be initialized */
    )
    {
    pList->HEAD	 = NULL;
    pList->TAIL  = NULL;
...
void lstConcat
    (
    register LIST *pDstList,        /* destination list */
    register LIST *pAddList         /* list to be added to dstList */
    )
    {
...
void lstDelete
    (
    register LIST *pList,   /* pointer to list descriptor */
    register NODE *pNode    /* pointer to node to be deleted */
    )
    {
...
void lstExtract
    (
    register LIST *pSrcList,      /* pointer to source list */
    register NODE *pStartNode,    /* first node in sublist to be extracted */
    register NODE *pEndNode,      /* last node in sublist to be extracted */
    register LIST *pDstList       /* ptr to list where to put extracted list */
    )
    {
    register int i;
    register NODE *pNode;
...
NODE *lstGet
    (
    register LIST *pList    /* ptr to list from which to get node */
    )
    {
    register NODE *pNode = pList->HEAD;
...
void lstInsert
    (
    register LIST *pList,   /* pointer to list descriptor */
    register NODE *pPrev,   /* pointer to node after which to insert */
    register NODE *pNode    /* pointer to node to be inserted */
    )
    {
    register NODE *pNext;
...
NODE *lstNth
    (
    register LIST *pList,           /* pointer to list descriptor */
    register int nodenum            /* number of node to be found */
    )
    {
    register NODE *pNode;
...
NODE *lstNStep
    (
    register NODE *pNode,           /* the known node */
...
int lstFind
    ...
    register NODE *pNode            /* pointer to node to search for */
    )
    {

    register NODE *pNextNode;
