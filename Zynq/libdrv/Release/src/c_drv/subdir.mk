...
src/c_drv/%.o: ../src/c_drv/%.c
	...
	arm-none-eabi-gcc -D_NDEBUG -D_PROT_UNIT_ -Wall -O2 -I"E:\xilinx\Zynq\libpub\src\h_public" -I"E:\xilinx\Zynq\libdrv\src\h_drv" -c -fmessage-length=0 -MT"$@" -mcpu=cortex-a9 -mfpu=vfpv3 -mfloat-abi=hard -I"E:\xilinx\Zynq\zynqBM_bsp\ps7_cortexa9_1\include" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
