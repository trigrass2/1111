...
src/c_public/%.o: ../src/c_public/%.c
	...
	arm-none-eabi-gcc -D_NDEBUG -D_PROT_UNIT_ -Wall -O2 -I"E:\xilinx\Zynq\libpub\src\h_public" -c -fmessage-length=0 -MT"$@" -mcpu=cortex-a9 -mfpu=vfpv3 -mfloat-abi=hard -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
